...
<main class="content">
    <div class="container-fluid">
        ...
        <div class="add-title">
            <a href="{{route('create.service')}}">Add Post</a>
        </div>
        {{-- end title --}}
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <table id="datatables-column-search-text-inputs" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        {{ $key + 1 }} . {!! strip_tags($service->title) !!}
                                    </td>
                                    <td>{{ ($service->created_at)->format('d/m/Y') }}</td>
                                    <td>
                                        <ul class="action">
                                            <li><a href="{{route('edit.service', $service->id)}}"
                                                    class="btn btn-success btn-sm">
                                                    <i class="fa fa-edit"></i></a> </li>
                                            <li>
                                                <form action="{!! route('delete.service', $service->id) !!}"
                                                    method="post">
                                                    @csrf
