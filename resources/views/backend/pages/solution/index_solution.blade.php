...
<main class="content">
    <div class="container-fluid">
        ...
        <div class="add-title">
            <a href="{{route('create.solution')}}">Add Post</a>
        </div>
        {{-- end title --}}
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <table id="datatables-column-search-text-inputs" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        {{ $key + 1 }} . {{ $solution->title }}
                                    </td>
                                    <td>
                                        <img class="img-sm my-2" src="{{asset('images/'.$solution->image)}}"
                                            alt="avatar">
                                    </td>
                                    <td>{{ ($solution->created_at)->format('d/m/Y') }}</td>
                                    <td>
                                        <ul class="action">
                                            <li><a href="{{route('edit.solution', $solution->id)}}"
                                                    class="btn btn-success btn-sm">
                                                    <i class="fa fa-edit"></i></a> </li>
                                            <li>
                                                <form action="{!! route('delete.solution', $solution->id) !!}"
                                                    method="post">
                                                    @csrf
