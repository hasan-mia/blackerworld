    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header title">
                <h2> <a href="{{route('create.whychoseus')}}">Add Post</a> </h2>
            </div>
            <div class="card-body">
                <form action="{{route('store.whychoseus')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" id="summernote" rows="10" cols="50"></textarea>
                            </div>
                            <!-- end description -->
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="number" placeholder="Add Number" class="form-control"
                                            required>
                                    </div>
                                </div>
