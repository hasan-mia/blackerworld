                ...
                <form action="{{route('update.blog-category', $BlogCategory->id)}}" method="post"
                    ...
                    <div class="row">
                        <div class="form-group">
                            <input name="name" value="{{ $BlogCategory->name }}" id="edtor-title" class="form-control"
                                required>
                        </div>
                        <!-- end title -->
                        <div class="col-md-8">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" cols="5" rows="5" id="summernote"
                                            class="form-control" required>{!! $BlogCategory->description !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            {{-- end row --}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="image" id="images"
                                                    placeholder="{{asset('images/'.$BlogCategory->image)}}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <img class="img-sm img-center my-1"
                                                src="{{asset('images/'.$BlogCategory->image)}}" alt="upload">
                                        </div>
