...
<main class="content">
    <div class="container-fluid">
        ...
        <div class="add-title">
            <a href="{{route('create.blog-category')}}">Add Category</a>
        </div>
        {{-- end title --}}
        <div class="row">
            <div class="col-12">
                        ...
                        <table id="datatables-column-search-text-inputs" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $key + 1 }} . {{ $BlogCategory->name }}
                                    </td>
                                    <td>
                                        <img class="img-sm my-2" src="{{asset('images/'.$BlogCategory->image)}}"
                                            alt="avatar">
                                    </td>
                                    <td>{{ ($BlogCategory->created_at)->format('d/m/Y') }}</td>
                                    <td>
                                        <ul class="action">
                                            <li><a href="{{route('edit.blog-category', $BlogCategory->id)}}"
                                                    class="btn btn-success btn-sm">
                                                    <i class="fa fa-edit"></i></a> </li>
                                            <li>
                                                <form action="{!! route('delete.blog-category', $BlogCategory->id) !!}"
                                                    method="post">
                                                    @csrf
