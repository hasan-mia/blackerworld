    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header title">
                <h2> <a href="{{route('create.product-category')}}">Add Category</a> </h2>
            </div>
            <div class="card-body">
                <form action="{{route('store.product-category')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <input name="name" placeholder="Add Category" id="edtor-title" class="form-control"
                                required>
                        </div>
                        <!-- end title -->
                        <div class="col-md-8">
