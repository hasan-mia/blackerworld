    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header title">
                <h2> <a href="{{route('create.banner')}}">Add Post</a> </h2>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="link" placeholder="Add Link" class="form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meta" placeholder="Meta Title" class="form-control"
                                        required>
                                </div>
